(function () {
  var SELECTOR =
    "article.post .js-link-preview[data-url], article.post-list .js-link-preview--feed[data-url]";
  ...
  function enhanceNode(node) {
    if (node.dataset.linkPreviewEnhanced === "1") {
      return;
    }
    ...
    node.dataset.linkPreviewEnhanced = "1";
  ...
  function init(scope) {
    var nodes = collectNodes(scope || document);
    if (!nodes.length) {
      return;
    }
  ...
  document.addEventListener("magicdpd:items-appended", function (event) {
