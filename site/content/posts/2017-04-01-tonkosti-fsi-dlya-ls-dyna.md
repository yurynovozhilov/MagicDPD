...
original_url: https://t.me/MagicDPD/317
source: tg
...
Новая лекция от #LSTC по тонкостям настройки #FSI для #LSDYNA. В лекции подробно разбирается совместная работа #Implicit и #ICFD решателя, алгоритм передачи данных. В конце есть ссылки на учебные примеры.
