...
При этом, есть даже неплохое сравнение с экспериментом, и возможность считать на #GPU!

https://www.youtube.com/watch?v=B8mP9E75D08
http://www.dual.sphysics.org

DualSPHysics: GPU and OpenMP based Smoothed Particle Hydrodynamics
http://www.dual.sphysics.org/
DualSPHysics: A combined CUDA and OpenMP implementation of the Smoothed Particle Hydrodynamics method based on the advanced SPHysics code.
