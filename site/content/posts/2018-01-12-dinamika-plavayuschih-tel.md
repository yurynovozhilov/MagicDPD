...
- description: DualSPHysics has been coupled with the MoorDyn library.MoorDyn is a
  ...
  url: https://www.youtube.com/watch?v=ToEsV0FDs0I
source: vk
tags:
- MoorDyn
- GPU
...
Расчет выполнен в паре кодов DualSPHysics и MoorDyn. В этой связке DualSPHysics, SPH код разработанный NVIDIA Research Center, отвечает за динамику жидкости и FSI, а MoorDyn моделирует поведение швартовых.
