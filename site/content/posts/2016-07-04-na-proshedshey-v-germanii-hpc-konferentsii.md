---
author: GlukRazor
date: 2016-07-04 06:30:56+00:00
images:
...
- description: We create the world’s fastest supercomputer and largest gaming platform.
  ...
  url: http://www.nvidia.ru/object/tesla-p100-pcie-20160620-ru.html
source: vk
tags:
- K80
- Maxwell
...
- NVIDIA
- P100
title: "На прошедшей в Германии #HPC конференции #NVIDIA выкатила свою новую числодробилку."
---

На смену двухчиповой #K80 приходит #P100. А для полной неразберихи еще есть #Tesla M60 которая конечно имеет бренд Теслы, но предназначена для #VDI, так как вычислитель из нее совсем никакой (ядро #Maxwell имеет очень низкую производительность в операциях с двойной точностью)
