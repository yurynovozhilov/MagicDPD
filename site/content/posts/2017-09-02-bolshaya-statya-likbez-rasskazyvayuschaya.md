...
- FDM
- FEM
title: "Большая статья - ликбез, рассказывающая про то, что такое метод конечных элементов (#МКЭ, #FEM) и почему его не надо путать с методом конечных разностей (#FDM)."
---

Полезно не только наживать на кнопки, но и немного помнить про методы решения систем уравнений.

http://feaforall.com/difference-between-fem-and-fdm/ 🔗 What’s the difference between FEM and FDM? - FEA for All

http://ift.tt/2wHGYaz
http://feaforall.com/difference-between-fem-and-fdm/
