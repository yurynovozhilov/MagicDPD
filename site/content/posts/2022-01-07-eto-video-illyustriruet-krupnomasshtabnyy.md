...
Это видео иллюстрирует крупномасштабный трехмерный КЭ расчет, выполненный в #ONERA с помощью программного обеспечения #Zset finite element с использованием автоматических адаптивных сеток.
