...
Решатель MSC.Dytran разработан как код с явной схемой интегрирования по времени и вполне может конкурировать с такими монстрами как #ANSYS #AUTODYN и #LSTC #LSDYNA. Сплошной #Explicit :-)
