...
#RTM - это когда моделируется процесс пропитки композитов связующими смолами (Resin Transfer Molding). Ребята из #LSTC показали как посчитать это в #CFD модуле #LSDYNA через фильтрацию в пористых средах. Несимметричный результат - следствие анизотропной пористости.
