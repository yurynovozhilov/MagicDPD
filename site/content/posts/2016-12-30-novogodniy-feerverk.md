...
- description: Free and easy sample of particle blast input desk for LS-DYNA R9https://vk.com/doc11568_440462041
  ...
  url: https://www.youtube.com/watch?v=qOUo3JLNUao
- description: ''
  image: ''
  title: Error | VK
...
Насколько мне известно, сейчас в интернете нет ни одного готового примера расчета взрыва . По крайней мере, за неделю поиска, я ничего не нашел. Так что я подготовил самый простой пример для выполнения подобного расчета.
