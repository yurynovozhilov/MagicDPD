...
Пост будет очень полезен всем пользователям CFD, считающим задачи, связанные с конвекцией или волнами. Ну а пользователям #explicit кодов без знаний про CFL даже кнопку solve нажимать нельзя.
