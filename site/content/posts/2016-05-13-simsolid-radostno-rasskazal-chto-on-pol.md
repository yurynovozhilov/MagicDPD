...
SOLIDWORKS 2013, service pack 5.0, Win7/Win8, 64-bit
Дальше - больше!

Напомню, что SimSolid  позволяет выполнять расчеты механики без построения сетки и способен обрабатывать совершенно неподготовленную #CAD геометрию.

[SIMSOLID now integrates directly with SOLIDWORKS](https://www.simsolid.com/2016/05/simsolid-now-integrates-directly-with-solidworks/)
