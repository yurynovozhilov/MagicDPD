---
layout: post
title: "В догонку к вебинару по #MAC #Marc 2015, который я просмотрел по диагонали (теперь то я его пересмотрю внимательно) - оказывается там появился 3D рост трещин с адаптивным перестроением сетки."
