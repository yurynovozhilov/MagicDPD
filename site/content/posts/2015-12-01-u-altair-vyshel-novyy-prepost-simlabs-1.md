---
layout: post
title: "У #Altair вышел новый препост #SimLabs 14.0. Утверждается, что теперь пользователю не надо чистить CAD геометрию - сеточный генератор сам разбирает ее на лету и удаляет все ненужное."
